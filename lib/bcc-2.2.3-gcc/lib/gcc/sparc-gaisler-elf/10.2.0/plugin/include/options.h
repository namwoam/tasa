...
enum opt_code
{
  ...
  OPT_m32 = 1596,                            /* -m32 */
  OPT_m64 = 1597,                            /* -m64 */
  OPT_mapp_regs = 1598,                      /* -mapp-regs */
  OPT_mcbcond = 1599,                        /* -mcbcond */
  OPT_mcmodel_ = 1600,                       /* -mcmodel= */
  OPT_mcpu_ = 1601,                          /* -mcpu= */
  OPT_mdebug_ = 1602,                        /* -mdebug= */
  OPT_mfaster_structs = 1603,                /* -mfaster-structs */
  OPT_mfix_at697f = 1604,                    /* -mfix-at697f */
  OPT_mfix_b2bst = 1605,                     /* -mfix-b2bst */
  OPT_mfix_gr712rc = 1606,                   /* -mfix-gr712rc */
  OPT_mfix_tn0013 = 1607,                    /* -mfix-tn0013 */
  OPT_mfix_ut699 = 1608,                     /* -mfix-ut699 */
  OPT_mfix_ut700 = 1609,                     /* -mfix-ut700 */
  OPT_mflat = 1610,                          /* -mflat */
  OPT_mfmaf = 1611,                          /* -mfmaf */
  OPT_mfpu = 1612,                           /* -mfpu */
  OPT_mfsmuld = 1613,                        /* -mfsmuld */
  OPT_mhard_float = 1614,                    /* -mhard-float */
  OPT_mhard_quad_float = 1615,               /* -mhard-quad-float */
  OPT_mlra = 1616,                           /* -mlra */
  OPT_mmemory_model_ = 1617,                 /* -mmemory-model= */
  OPT_mpopc = 1618,                          /* -mpopc */
  OPT_mptr32 = 1619,                         /* -mptr32 */
  OPT_mptr64 = 1620,                         /* -mptr64 */
  OPT_mrelax = 1621,                         /* -mrelax */
  OPT_msoft_float = 1622,                    /* -msoft-float */
  OPT_msoft_quad_float = 1623,               /* -msoft-quad-float */
  OPT_mstack_bias = 1624,                    /* -mstack-bias */
  OPT_mstd_struct_return = 1625,             /* -mstd-struct-return */
  OPT_msubxc = 1626,                         /* -msubxc */
  OPT_mtune_ = 1627,                         /* -mtune= */
  OPT_munaligned_doubles = 1628,             /* -munaligned-doubles */
  OPT_muser_mode = 1629,                     /* -muser-mode */
  OPT_mv8plus = 1630,                        /* -mv8plus */
  OPT_mvis = 1631,                           /* -mvis */
  OPT_mvis2 = 1632,                          /* -mvis2 */
  OPT_mvis3 = 1633,                          /* -mvis3 */
  OPT_mvis4 = 1634,                          /* -mvis4 */
  OPT_mvis4b = 1635,                         /* -mvis4b */
  OPT_n = 1636,                              /* -n */
  OPT_name_sort = 1637,                      /* -name-sort */
  OPT_no_canonical_prefixes = 1638,          /* -no-canonical-prefixes */
  OPT_no_integrated_cpp = 1639,              /* -no-integrated-cpp */
  OPT_no_pie = 1640,                         /* -no-pie */
  OPT_nocpp = 1641,                          /* -nocpp */
  OPT_nodefaultlibs = 1642,                  /* -nodefaultlibs */
  OPT_nolibc = 1643,                         /* -nolibc */
  OPT_nophoboslib = 1644,                    /* -nophoboslib */
  OPT_nostartfiles = 1645,                   /* -nostartfiles */
  OPT_nostdinc = 1646,                       /* -nostdinc */
  OPT_nostdinc__ = 1647,                     /* -nostdinc++ */
  OPT_nostdlib = 1648,                       /* -nostdlib */
  OPT_o = 1649,                              /* -o */
  OPT_objects = 1650,                        /* -objects */
  OPT_p = 1651,                              /* -p */
  OPT_pass_exit_codes = 1652,                /* -pass-exit-codes */
  /* OPT_pedantic = 1653, */                 /* -pedantic */
  OPT_pedantic_errors = 1654,                /* -pedantic-errors */
  OPT_pg = 1655,                             /* -pg */
  OPT_pie = 1656,                            /* -pie */
  OPT_pipe = 1657,                           /* -pipe */
  OPT_print_file_name_ = 1658,               /* -print-file-name= */
  OPT_print_libgcc_file_name = 1659,         /* -print-libgcc-file-name */
  OPT_print_multi_directory = 1660,          /* -print-multi-directory */
  OPT_print_multi_lib = 1661,                /* -print-multi-lib */
  OPT_print_multi_os_directory = 1662,       /* -print-multi-os-directory */
  OPT_print_multiarch = 1663,                /* -print-multiarch */
  OPT_print_objc_runtime_info = 1664,        /* -print-objc-runtime-info */
  OPT_print_prog_name_ = 1665,               /* -print-prog-name= */
  OPT_print_search_dirs = 1666,              /* -print-search-dirs */
  OPT_print_sysroot = 1667,                  /* -print-sysroot */
  OPT_print_sysroot_headers_suffix = 1668,   /* -print-sysroot-headers-suffix */
  OPT_print_value = 1669,                    /* -print-value */
  OPT_qfix_tn0018 = 1670,                    /* -qfix-tn0018 */
  OPT_qnano = 1671,                          /* -qnano */
  OPT_qsvt = 1672,                           /* -qsvt */
