...
#define HAVE_atomic_loadqi (TARGET_V9)
#define HAVE_atomic_loadhi (TARGET_V9)
#define HAVE_atomic_loadsi (TARGET_V9)
#define HAVE_atomic_loaddi (TARGET_V9)
#define HAVE_atomic_storeqi (TARGET_V9)
#define HAVE_atomic_storehi (TARGET_V9)
#define HAVE_atomic_storesi (TARGET_V9)
#define HAVE_atomic_storedi (TARGET_V9)
