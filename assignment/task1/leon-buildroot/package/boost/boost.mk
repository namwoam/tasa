...
ifeq ($(BR2_sparc_leon3),y)
BOOST_OPTS += architecture=sparc instruction-set=leon3
else ifeq ($(BR2_sparc_leon5),y)
BOOST_OPTS += architecture=sparc instruction-set=leon5
